(function($) {
  ...
  $(function() {
    ...
    if ($("#gender-chart").length) {
      var GenderChartCanvas = $("#gender-chart").get(0).getContext("2d");
      ...
      document.getElementById('gender-legend').innerHTML = GenderChart.generateLegend();
    }
    if ($("#gender-chart-dark").length) {
      var GenderChartCanvas = $("#gender-chart-dark").get(0).getContext("2d");
      var GenderChart = new Chart(GenderChartCanvas, {
        type: 'bar',
        data: {
          labels: ["2010", "2013", "2016", "2019", "2022"],
    ...
    if ($("#genderpie-chart").length) {
      ...
      var genderpieChartCanvas = $("#genderpie-chart").get(0).getContext("2d");
      var genderpieChart = new Chart(genderpieChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
        plugins: genderpieChartPlugins
      });
      document.getElementById('genderpie-legend').innerHTML = genderpieChart.generateLegend();
    }
    if ($("#genderpie-chart-dark").length) {
      var areaData = {
        labels: ["Male", "Female"],
        datasets: [{
            data: [88333, 66093],
      ...
      var genderpieChartCanvas = $("#genderpie-chart-dark").get(0).getContext("2d");
      var genderpieChart = new Chart(genderpieChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
    ...
    if ($("#pop-chart").length) {
      var areaData = {
        ...
        datasets: [{
            data: [60, 70, 70, 50, 50],
            backgroundColor: [
              "#4B49AC","#FFC100", "#FF0000", "#248AFD", "#464646",
            ],
            borderColor: "rgba(0,0,0,0)"
          }
        ]
      ...
      var areaOptions = {
        ...
        legendCallback: function(chart) { 
          var text = [];
          text.push('<div class="report-chart">');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[0] + '"></div><p class="mb-0">Infant</p></div>');
            text.push('<p class="mb-0">495343</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[1] + '"></div><p class="mb-0">Child</p></div>');
            text.push('<p class="mb-0">630983</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[2] + '"></div><p class="mb-0">Teenager</p></div>');
            text.push('<p class="mb-0">290831</p>');
            text.push('</div>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[3] + '"></div><p class="mb-0">Adult</p></div>');
            text.push('<p class="mb-0">290831</p>');
            text.push('</div>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[4] + '"></div><p class="mb-0">Senior</p></div>');
            text.push('<p class="mb-0">290831</p>');
            text.push('</div>');
          text.push('</div>');
          return text.join("");
      ...
      var southAmericaChartCanvas = $("#pop-chart").get(0).getContext("2d");
      ...
      document.getElementById('pop-legend').innerHTML = southAmericaChart.generateLegend();
    }
    //////////////////////////


    if ($("#purk-chart").length) {
      var areaData = {
        labels: ["Orange", "Banana", "Pomegrante", "Liche"],
        datasets: [{
            data: [60, 70, 70, 50, 50],
            backgroundColor: [
              "#4B49AC","#FFC100", "#FF0000", "#248AFD",
            ],
            borderColor: "rgba(0,0,0,0)"
          }
        ]
      ...
      var southAmericaChartCanvas = $("#purk-chart").get(0).getContext("2d");
      var southAmericaChart = new Chart(southAmericaChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
      ...
      document.getElementById('purk-legend').innerHTML = southAmericaChart.generateLegend();
    }
    

    //////////////////////
    if ($("#pop-chart-dark").length) {
      var areaData = {
        labels: ["Jan", "Feb", "Mar"],
        datasets: [{
            data: [60, 70, 70],
      ...
      var southAmericaChartCanvas = $("#pop-chart-dark").get(0).getContext("2d");
      var southAmericaChart = new Chart(southAmericaChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
